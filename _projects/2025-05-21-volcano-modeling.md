...
image: /images/2025-05-geophysics/simple_volcano_diagram.png
show_excerpt: true
draft: false
summary: "In the fall of 2025, I was living in Seattle, working as a software engineer at SpaceX, and looking for a way to join my girlfriend in Palo Alto."
math: true
---
...
<img align="left" width="50%" src="/images/2025-05-geophysics/simple_volcano_diagram.png" alt="Diagram of the simplified volcano conduit model">
...
To calculate the viscous drag term, we assume the velocity in the melt increases linearly from zero at the bottom of the conduit to $u_z$ at the top. See my [weekly notes](/files/geophysics/volcano_project/weekly_notes/2025.03.21.experiments.html) from March where I discuss this.

![lumped parameter model](/images/2025-05-geophysics/lumped_parameter_model.png)
...
![infrasound validation](/images/2025-05-geophysics/infrasound_validation.png)
...
![monopole pressure vs time](/images/2025-05-geophysics/monopole_pressure_vs_time.png)
...
![pressure verification](/images/2025-05-geophysics/pressure_verification.png)

The next step is to apply the volume integral approach to the double divergence of the lighthill stress tensor. I do that in my notes from the [week of 2025.05.19](/files/geophysics/volcano_project/weekly_notes/2025.05.19.experiments.html). However, because I don't trust my input, I also don't trust my output.
